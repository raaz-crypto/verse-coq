...
| (a - c)(b + d)                |  10 | v₁₀ = v₅ * v₆    | 13 (A) |     | v₁₀ |     |     |     |     | x₃ = x₂ * t₁     | 61       | 61      |
...
| 4ac (a² + A ac + c²) = Z₂ᵢ    |  19 | v₁₉ = v₁₆ * v₁₈  | ∞  (A) |     |     | v₁₉ |     |     |     | z₂ = t₁ * z₃     | 61       | 61 (C)  |
| 4 X(bc - ad)²        = 4Z₂ᵢ₊₁ |  20 | v₂₀ = v₁₄ * X(B) | ∞  (A) |     |     |     | v₂₀ |     |     | z₃ = x₃ * X(B)   | 61       | 61 (C)  |
| 4 (ab - cd)²         = 4X₂ᵢ₊₁ |  21 | v₂₁ = v₁₂²       | ∞  (A) |     | v₂₁ |     |     |     |     | x₃ = t₀²         | 61       | 61 (C)  |
|-------------------------------+-----+------------------+--------+-----+-----+-----+-----+-----+-----+------------------+----------+---------|


The need column says till what instruction is the value
need. Additionally it also ways whether the value is needed in a
multiplication or in an addition. The size column says what bit size
we expect the limbs to be in. A C field in the size column means a single carry
is required to be done there says whether we need to
