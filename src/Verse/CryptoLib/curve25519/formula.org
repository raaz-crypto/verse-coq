...
| Value                         | SSA | SSA program      | Need   | x₂  | x₃  | z₂  | z₃  | t₀  | t₁  | Inst             | Size | Req Size | Prop |
|-------------------------------+-----+------------------+--------+-----+-----+-----+-----+-----+-----+------------------+------+----------+------|
| a                             |   0 | v₀ = a           | 5  (A) | v₀  |     |     |     |     |     |                  |   41 |          |    0 |
| b                             |   1 | v₁ = b           | 7  (A) |     | v₁  |     |     |     |     |                  |   41 |          |    0 |
| c                             |   2 | v₂ = c           | 5  (S) |     |     | v₂  |     |     |     |                  |  std |          |    0 |
| d                             |   3 | v₃ = d           | 7  (S) |     |     |     | v₃  |     |     |                  |  std |          |    0 |
|-------------------------------+-----+------------------+--------+-----+-----+-----+-----+-----+-----+------------------+------+----------+------|
| a + c                         |   4 | v₄ = v₀ + v₂     | 9  (M) |     |     |     |     | v₄  |     | t₀ = x₂ + z₂     |   42 | std      |    1 |
| a - c                         |   5 | v₅ = v₀ - v₂     | 11 (M) | v₅  |     |     |     |     |     | x₂ -= z₂         |   42 | std      |    1 |
| b + d                         |   6 | v₆ = v₁ + v₃     | 10 (M) |     |     |     |     |     | v₆  | t₁ = x₃ + z₃     |   42 | std      |    1 |
| b - d                         |   7 | v₇ = v₁ - v₃     | 8  (M) |     | v₇  |     |     |     |     | x₃ -= z₃         |   42 | std      |    1 |
| (a + c)(b - d)                |   8 | v₈ = v₄ * v₇     | 13 (A) |     |     |     | v₈  |     |     | z₃ = x₃ * t₀     |   61 | 40       |    1 |
| (a + c)²                      |   9 | v₉ = v₄²         | 18 (M) |     |     | v₉  |     |     |     | z₂ = t₀²         |   61 | std      |    2 |
| (a - c)(b + d)                |  10 | v₁₀ = v₅ * v₆    | 13 (S) |     | v₁₀ |     |     |     |     | x₃ = x₂ * t₁     |   61 | std      |    2 |
| (a - c)²                      |  11 | v₁₁ = v₅²        | 16 (M) |     |     |     |     |     | v₁₁ | t₁ = x₂²         |   61 | std      |    2 |
|-------------------------------+-----+------------------+--------+-----+-----+-----+-----+-----+-----+------------------+------+----------+------|
| 2(ab - cd)                    |  12 | v₁₂ = v₈ + v₁₀   | 21 (M) |     |     |     |     | v₁₂ |     | t₀ = z₃ + x₃     |   41 | std      |    1 |
| 2(bc - ad)                    |  13 | v₁₃ = v₈ - v₁₀   | 14 (M) |     |     |     | v₁₃ |     |     | z₃ -= x₃         |   42 | std      |    1 |
| 4(bc - ad)²                   |  14 | v₁₄ = v₁₃²       | 20 (M) |     | v₁₄ |     |     |     |     | x₃ = z₃²         |   61 | std      |    2 |
| (a² - c²)²           = X₂ᵢ    |  15 | v₁₅ = v₉ * v₁₁   | ∞  (A) | v₁₅ |     |     |     |     |     | x₂ = z₂ * t₁     |   61 | 40       |    1 |
| 4ac                           |  16 | v₁₆ = v₉ - v₁₁   | 19 (M) |     |     |     | v₁₆ |     |     | z₃ = z₂ - t₁     |   27 | 27       |    0 |
| 486660 ac = (A - 2)a c        |  17 | v₁₇ = 121665 v₁₆ | 18 (A) |     |     |     |     |     | v₁₇ | t₁ = 121665 * z₃ |   44 | 44       |    0 |
| a² + A ac + c²                |  18 | v₁₈ = v₉ + v₁₇   | 19 (M) |     |     |     |     |     | v₁₈ | t₁ += z₂         |   45 | std      |    1 |
| 4ac (a² + A ac + c²) = Z₂ᵢ    |  19 | v₁₉ = v₁₆ * v₁₈  | ∞  (S) |     |     | v₁₉ |     |     |     | z₂ = t₁ * z₃     |   61 | std      |    2 |
| 4 X(bc - ad)²        = 4Z₂ᵢ₊₁ |  20 | v₂₀ = v₁₄ * X(B) | ∞  (S) |     |     |     | v₂₀ |     |     | z₃ = x₃ * X(B)   |   61 | std      |    2 |
| 4 (ab - cd)²         = 4X₂ᵢ₊₁ |  21 | v₂₁ = v₁₂²       | ∞  (A) |     | v₂₁ |     |     |     |     | x₃ = t₀²         |   61 | 40       |    1 |
|-------------------------------+-----+------------------+--------+-----+-----+-----+-----+-----+-----+------------------+------+----------+------|
...
The ∞ in the need column means that the register is used in the next
Montgomery step. Since these values are needed in the next step their
requirement reflects exactly how the corresponding register is used in
the beginning of the Step.

The size field gives what size bound we have for the register and Req
size says what size we want for correct operation. Final column says
how many carry steps need to be executed for the given registers.
